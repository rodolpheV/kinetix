...
namespace Kinetix.Reporting {
    ...
    public static class PowerpointHelper {
        ...
        /// <summary>
        /// Variable only used for debugging. Set it to true to activate each validation step.
        /// </summary>
        private static readonly bool validateMode = false;
        ...
        /// <summary>
        /// Check whether an object is valid only if validateMode is true.
        /// </summary>
        /// <param name="xmlElement">Object to validate.</param>
        /// <returns>Is a valid openXml object.</returns>
        private static bool isValidAndDebugging(OpenXmlElement xmlElement) {
            return validateMode ? isValid(xmlElement) : true;
        }

        /// <summary>
        /// Check whether an object is valid only if validateMode is true.
        /// </summary>
        /// <param name="xmlPackage">Object to validate.</param>
        /// <returns>Is a valid openXml object.</returns>
        private static bool isValidAndDebugging(OpenXmlPackage xmlPackage) {
            return validateMode ? isValid(xmlPackage) : true;
        }

        /// <summary>
        /// Check whether an object is valid only if validateMode is true.
        /// </summary>
        /// <param name="xmlPart">Object to validate.</param>
        /// <returns>Is a valid openXml object.</returns>
        private static bool isValidAndDebugging(OpenXmlPart xmlPart) {
            return validateMode ? isValid(xmlPart) : true;
        }
        ...
        /// <param name="xmlElement">Object to validate.</param>
        /// <returns>Is a valid openXml object.</returns>
        public static bool isValid(OpenXmlElement xmlElement) {
            var errors = validator.Validate(xmlElement);
        ...
        /// <param name="xmlPackage">Object to validate.</param>
        /// <returns>Is a valid openXml object.</returns>
        public static bool isValid(OpenXmlPackage xmlPackage) {
            var errors = validator.Validate(xmlPackage);
            return errors.Count() == 0;
        }
        ...
        /// <param name="xmlPart">Object to validate.</param>
        /// <returns>Is a valid openXml object.</returns>
        public static bool isValid(OpenXmlPart xmlPart) {
            var errors = validator.Validate(xmlPart);
            return errors.Count() == 0;
        }
        ...
        public static PresentationDocument CreatePresentationWithOneEmptySlide(string fileName, int slideWidth = 9144000, int slideHeight = 6858000) {
            ...
            if (!isValidAndDebugging(presentationDoc)) throw new ApplicationException("Invalid Xml presentation generated by CreatePresentationWithOneEmptySlide.");
        ...
        public static ShapeTree GetShapeTreeOfFirstSlide(PresentationDocument presentationDocument) {
            ...
            if (!isValidAndDebugging(shapeTree)) throw new ApplicationException("Invalid Xml presentation generated by GetShapeTreeOfFirstSlide.");
        ...
        public static void AddImage(OpenXmlElement parent, Stream logoStream, int left, int top, int width, int height) {
            ...
            if (!isValidAndDebugging(slide)) throw new ApplicationException("Invalid Xml presentation generated by AddImage.");
        }
        ...
        public static Shape CreatePolygon(List<int[]> list, string colorCode = null) {
            ...
            if (!isValidAndDebugging(shape1)) throw new ApplicationException("Invalid Xml presentation generated by CreatePolygon.");
            return shape1;
        ...
        public static D.Paragraph AddParagraph(Shape shape, string text, int fontSize = 800, string fontColorCode = "212121", bool bold = false, D.TextAlignmentTypeValues align = D.TextAlignmentTypeValues.Left) {
            ...
            if (!isValidAndDebugging(paragraph0)) throw new ApplicationException("Invalid Xml presentation generated by AddParagraph.");
            return paragraph0;
        }
        ...
        /// <param name="fontColorCode">RGB hexadecimal font color code. Default: 212121. Format: RRGGBB.</param>
        /// <param name="bold">Should the text be bold? Default: false.</param>
        /// <param name="italic">Should the text be italic? Default: false.</param>
        public static void AddTextRun(D.Paragraph paragraph, string text, int fontSize = 800, string fontColorCode = "212121", bool bold = false, bool italic = false) {
            if (fontSize <= 0) throw new ArgumentOutOfRangeException("fontSize", fontSize, "fontSize should be positive.");
            CheckHexaColorCode(fontColorCode);

            D.Run run2 = new D.Run();

            D.RunProperties runProperties2 = new D.RunProperties() { Language = "en-US", FontSize = fontSize, Bold = bold, Italic = italic };
            ...
            if (!isValidAndDebugging(paragraph)) throw new ApplicationException("Invalid Xml presentation generated by AddTextRun.");
        ...
        public static GroupShape CreateGroupShape(int left, int top, int width, int height) {
            ...
            if (!isValidAndDebugging(groupShape1)) throw new ApplicationException("Invalid Xml presentation generated by CreateGroupShape.");
            return groupShape1;
        }
        ...
        public static ConnectionShape CreateConnectionShape(Shape startShape, Shape endShape, int[] startPoint, int[] endPoint) {
            ...
            if (!isValidAndDebugging(connectionShape1)) throw new ApplicationException("Invalid Xml presentation generated by CreateConnectionShape.");
        ...
        public static void ResizeGroup(GroupShape groupShape, int width, int height) {
            ...
            if (!isValidAndDebugging(groupShape)) throw new ApplicationException("Invalid Xml presentation generated by ResizeGroup.");
        }
        ...
        private static void CreatePresentationParts(PresentationPart presentationPart, int slideWidth, int slideHeight) {
            ...
            if (!isValidAndDebugging(presentationPart)) throw new ApplicationException("Invalid Xml presentation generated by CreatePresentationParts.");
        }
        ...
        private static SlidePart CreateSlidePart(PresentationPart presentationPart) {
            ...
            if (!isValidAndDebugging(slidePart1)) throw new ApplicationException("Invalid Xml presentation generated by CreateSlidePart.");
            return slidePart1;
        }
        ...
        private static SlideLayoutPart CreateSlideLayoutPart(SlidePart slidePart1) {
            ...
            if (!isValidAndDebugging(slideLayoutPart1)) throw new ApplicationException("Invalid Xml presentation generated by CreateSlideLayoutPart.");
        ...
        private static ThemePart CreateTheme(SlideMasterPart slideMasterPart1) {
            ...
            if (!isValidAndDebugging(themePart1)) throw new ApplicationException("Invalid Xml presentation generated by CreateTheme.");
            return themePart1;
        ...
        private static NonVisualShapeProperties CreateNonVisualShapeProperties(uint id, string typeName) {
            ...
            if (!isValidAndDebugging(nonVisualShapeProperties1)) throw new ApplicationException("Invalid Xml presentation generated by CreateNonVisualShapeProperties.");
